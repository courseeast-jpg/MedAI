...
Env-on aggregate evaluation of the DIAG-17 PDF text/layout quality helper. Reports-only.
...
## Env-on records evaluated: 21
## Emitted metadata count: 21
## Excluded pool emission count: 0
...
- `helper_still_default_disabled_after_eval`: True
- `all_records_review_bound`: True

## Progress

- Before: residual Unknown ~99.95% done / ~0.05% remaining; whole project ~90.5% done / ~9.5% remaining.
- After: residual Unknown ~99.97% done / ~0.03% remaining; whole project ~90.8% done / ~9.2% remaining.
