...
- Generated at: `2026-05-01T15:43:08.380067+00:00`
...
- empty_extraction: `0`
- confidence_below_threshold: `3`
- low_entity_count: `0`
- low_coverage: `4`
- low_diversity: `0`
- low_extractor_weight: `0`
...
| --- | --- | --- | --- | --- | --- | --- | ---: | --- | --- | ---: | --- | ---: | --- | --- | --- | ---: | --- | --- | --- |
| Results 1.pdf | accepted | other | no | no | scanned_or_low_text | usable_with_review | 0.745 | existing_pdf_pipeline | low_text_density, table_structure_loss, accepted_clean_input | 4 | spacy | 1030 | existing_pdf_pipeline | no | latency_too_high:7653.000 | 0.767 |  | accept_with_route_audit |  |
| Results 2.pdf | accepted | other | no | no | scanned_or_low_text | usable_with_review | 0.735 | existing_pdf_pipeline | low_text_density, table_structure_loss, accepted_clean_input | 3 | spacy | 953 | existing_pdf_pipeline | no | latency_too_high:8184.000 | 0.693 |  | accept_with_route_audit |  |
| Test Results 2.pdf | review_ocr_quality | ocr_quality | yes | good_input_but_downstream_ocr_review | digital_clean_text | good | 0.818 | existing_pdf_pipeline | table_structure_loss, extraction_low_coverage, classifier_legacy_ocr_flag, legacy_normalized_low_coverage | 6 | spacy | 2732 | existing_pdf_pipeline | no | gemini_quota_or_rate_limit | 0.7 | low_coverage | accept_with_route_audit |  |
