...
- Generated at: `2026-05-01T16:06:51.172518+00:00`
...
- Phase37 empty: `0`
- Phase37 review_ocr_quality improved: `3`
...
| --- | --- | --- | --- | ---: | --- | --- | --- | --- |
| Results 1.pdf | review | scanned_or_low_text | usable_with_review | 0.745 | existing_pdf_pipeline | no | low_text_density, table_structure_loss, extraction_low_coverage, extraction_low_confidence, safety_gate_low_confidence | yes |
...
| Test Results 2.pdf | review | digital_clean_text | good | 0.818 | existing_pdf_pipeline | no | table_structure_loss, extraction_low_coverage, lab_table_recovered, lab_table_recovered_review_only | yes |
