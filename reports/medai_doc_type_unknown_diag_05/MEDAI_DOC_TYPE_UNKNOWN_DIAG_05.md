...
- table_like_structure_detected_counts: `yes`=12
- numeric_content_bucket_counts: `medium`=12
- alphabetic_content_bucket_counts: `high`=12
- section_heading_shape_detected_counts: `no`=11, `yes`=1
- administrative_form_shape_detected_counts: `yes`=12
- date_or_schedule_shape_detected_counts: `yes`=12
- lab_table_shape_detected_counts: `no`=12
- imaging_modality_shape_detected_counts: `no`=12
- medical_abbreviation_shape_detected_counts: `no`=12
- dominant_script_counts: `latin`=12
- detector_confidence_bucket_counts: `high`=12
- language_detector_input_bucket_counts: `sufficient`=12
- language_visibility_status_counts: `latin_visible_language_unknown`=12
- symbol_content_bucket_counts: `medium`=12
- page_count_bucket_counts: `few`=9, `many`=1, `single`=2
- size_bucket_counts: `large`=1, `medium`=11
