...
- `final_batch_50-20260425T023112027145_0000` -> processed=46 written=45 queued=1 quota=4 avg_conf=0.700
...
- `final_batch_50-20260425T012114151373_0000` -> `final_batch_50-20260425T023112027145_0000` status=STABLE deltas={'processed': 0, 'written': -1, 'queued_for_review': 1, 'quota_blocked': 0, 'avg_confidence': 0.0}
  explanation: Derived queued document count changed by 1; inspect review counts and quota behavior for this run.
