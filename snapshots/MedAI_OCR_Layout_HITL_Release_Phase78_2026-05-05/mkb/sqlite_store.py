        ...
        with self._get_conn() as conn:
            conn.execute("""
                INSERT OR REPLACE INTO records VALUES (
                    ...
                    :source_count, :status, :tier, :ddi_checked, :ddi_status, :ddi_findings_json,
                    :safety_action, :extraction_method, :resolution_id, :resolution_action,
                    :resolution_confidence, :enrichment_confidence, :requires_review,
