...
- Timestamp: `2026-05-03T21:42:39.085091+00:00`
- Total files: `15`
- Processed files: `15`
- Accepted: `0`
- Review: `15`
...
| `file_014` | `c4a491bc06a43cda` | `a9daf124b06e6a1c` | `pdf` | `review` | `queued_for_review` | `phi3` | `0.634` | `good` | `extraction_low_confidence, safety_gate_low_confidence, lab_report_detected` | `` |
