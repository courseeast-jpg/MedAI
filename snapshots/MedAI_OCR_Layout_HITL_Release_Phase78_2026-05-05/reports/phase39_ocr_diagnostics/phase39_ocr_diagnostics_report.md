...
- Generated at: `2026-05-01T22:16:31.056740+00:00`
...
- Phase38 improved prior review_ocr_quality files: `4`

## Phase39 Diagnostics

- Total files: `8`
- OCR status mismatches: `1`
- review_ocr_quality files: `2`
...
| Test Results 2.pdf | good | 0.818 | digital_clean_text | review | table_structure_loss,extraction_low_coverage,extraction_low_confidence,safety_gate_low_confidence,lab_table_recovered,lab_table_recovered_review_only | 5 | 0.63 | no | yes | no |
...
| Test Results 4.pdf | good | 0.816 | scanned_or_low_text | accepted | accepted_clean_input | 3 | 0.693 | no | yes | no |
...
| Test Results 6.pdf | good | 0.809 | digital_clean_text | review | table_structure_loss,extraction_low_coverage,extraction_low_confidence,safety_gate_low_confidence,extraction_sparse_entities | 1 | 0.45 | no | yes | no |
| Urinalysis, Routine.pdf | usable_with_review | 0.925 | digital_clean_text | accepted | accepted_clean_input | 11 | 0.792 | no | no | no |
