...
def summarize_document(
    ...
    *,
    ...
    return {
        ...
        "text_quality_status": result.extractor_result.get("text_quality_status"),
        "text_quality_score": result.extractor_result.get("text_quality_score"),
        "ocr_fallback_used": bool(result.extractor_result.get("ocr_fallback_used", False)),
        "ocr_engine": result.extractor_result.get("ocr_engine"),
        "ocr_text_length": int(result.extractor_result.get("ocr_text_length", 0)),
        "pii_medical_label_preserved_count": int(
            result.extractor_result.get("pii_medical_label_preserved_count", 0)
        ),
        "pii_medical_label_preserved_terms": list(
            result.extractor_result.get("pii_medical_label_preserved_terms", [])
        ),
        "structured_parser_used": bool(result.extractor_result.get("structured_parser_used", False)),
        "structured_entities_count": int(result.extractor_result.get("structured_entities_count", 0)),
        "structured_parser_version": result.extractor_result.get("structured_parser_version"),
    }
