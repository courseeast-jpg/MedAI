...
def build_phase28_metrics(summary: dict[str, Any]) -> dict[str, Any]:
    ...
    pre_run_review_queue_items = int(production_mode.get("review_queue_items", canonical_validation["review_queue_items"]))
    current_run_review_queue_items = canonical_validation["review_queue_items"]
    ...
    return {
        ...
        "review_queue_items": pre_run_review_queue_items,
        "pre_run_review_queue_items": pre_run_review_queue_items,
        "current_run_review_queue_items": current_run_review_queue_items,
...
def build_phase28_report(metrics: dict[str, Any]) -> str:
    lines = [
        ...
        f"- Pre-run review queue items (gate input): `{metrics['pre_run_review_queue_items']}`",
        f"- Current run review queue items: `{metrics['current_run_review_queue_items']}`",
