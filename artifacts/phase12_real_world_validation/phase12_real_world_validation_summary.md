...
- Validation statuses: {'accepted': 45, 'rejected': 1}
...
- Total queued: 26
- Total blocked: 0
- Semantic enrichment applied: 45
...
- `long_noisy_03.pdf` -> status=processed outcome=queued_for_review validation=rejected confidence=0.345
