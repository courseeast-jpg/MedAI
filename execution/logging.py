...
class AuditLogger:
    ...
    def log(
        ...
        *,
        ...
        extractor_route: str,
        extractor_actual: str,
        requested_extractor_route: str | None = None,
        entity_count: int,
        confidence: float,
        outcome: str,
        validation_status: str = "accepted",
        ...
        event = {
            ...
            "extractor_route": extractor_route,
            "extractor_actual": extractor_actual,
            "requested_extractor_route": requested_extractor_route or extractor_route,
            "entity_count": int(entity_count),
            "confidence": float(confidence),
            "confidence_band": confidence_band,
            "raw_confidence": float(confidence if raw_confidence is None else raw_confidence),
            "calibrated_confidence": float(confidence if calibrated_confidence is None else calibrated_confidence),
            "calibration_reason": calibration_reason,
            "route_mismatch_flag": bool(route_mismatch_flag) if route_mismatch_flag is not None else False,
            "review_recommendation": review_recommendation,
            "intended_route": intended_route or requested_extractor_route or extractor_route,
            "actual_route": actual_route or extractor_actual,
