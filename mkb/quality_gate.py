...
from app.config import (
    DEDUP_SIMILARITY_THRESHOLD, MIN_CONFIDENCE_CLAUDE, MIN_CONFIDENCE_RULES,
    TIER_ACTIVE, TIER_HYPOTHESIS
)
...
class QualityGate:
    ...
    def check(
        ...
        if candidate.confidence < min_conf:
            self._log_ledger("quality_reject", candidate, session_id,
        ...
        if candidate.first_recorded:
            ...
            if age_days > 365 * 5:
                candidate = candidate.model_copy(update={
                    ...
                    "status": "active",  # still active, just flagged
                })
        ...
        if dup_id and dup_id != candidate.id:
            ...
            if existing:
                ...
                if existing.trust_level == candidate.trust_level:
                    ...
                    self._log_ledger("dedup_confirm", candidate, session_id,
    ...
    def _resolve_conflict(
        ...
        elif result.resolution in ("replace_with_new", "merge"):
